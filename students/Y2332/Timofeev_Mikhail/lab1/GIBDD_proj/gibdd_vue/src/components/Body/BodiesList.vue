  ...
  <v-row align="center" class="list px-3 mx-auto">
    ...
    <v-col cols="12" sm="12">
      <v-card class="mx-auto" tile>
        <v-card-title>Bodies</v-card-title>
...
export default {
  ...
  data() {
    return {
      ...
      search: "",
      headers: [
        { text: "Model", align: "start", value: "body_model", sortable: false },
        { text: "Type", value: "body_type", sortable: false },
  ...
  methods: {
    retrieveItems() {
      DataService.getAll()
        .then((response) => {
          this.items = response.data.data.map(this.getDisplayBody);
    ...
    addItem() {
      this.$router.push({ name: "add-body" });
    },
    ...
    getDisplayBody(body) {
      ...
      return {
        ...
        body_model: attributes.body_model,
      };
    },
  },
  mounted() {
