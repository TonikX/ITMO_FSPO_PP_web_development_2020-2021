...
from .models import CarOwner, auto, CarOwnership
...
def detail(request, id):
    ...
    return render(request, 'car_owner.html', {'CarOwner': p})

def list_view_CarOwner(request):
    text = {}
    text["dataset"] = CarOwner.objects.all()
