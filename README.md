...
## Лабораторная работа №1. Реализация web-приложения средствами Django WEB framework (Будет дополняться)
...
# Лабораторная работа 1.1 (Сложный путь для тех, кто хочет стать веб-разработчиком) (получаете 5 за курс - 100%). Реализация серверной части на django rest. Документирование API.
...
# Лабораторная работа 1.2.(Сложный путь для тех, кто хочет стать веб-разработчиком) (получаете 5 за курс - 100%). Реализация клиентской части средствами Vue.js.
