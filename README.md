...
**- Простой: Выполнить ЛР 1.1 - сделать простое веб-приложение без отдельного клентского приложения (Django WEB framework) (оценки 3-4-5(на 5 нужгно будет сделать ооочень крутую работу)**<br>
**- Сложный: Выполнить ЛР 1.2 - 1.3 - сделать более сложное веб-приложение состоящее из серверной части django rest framework и клиентской части на vue.js (оценки 4-5(на 4 нужно сделать совсем просто, на 5 нормально и выше))**<br>

## Лабораторная работа №1.1. Реализация web-приложения средствами Django WEB framework (Будет дополняться)
**Дедлайн: 4.04.21 10:00**
...
3) Перечислить в техническом задании (в свободной форме). Утвердить список интерфейсов в лабораторной работе с преподавателем.
4) ...

# Лабораторная работа 1.2 (Сложный путь для тех, кто хочет стать веб-разработчиком) (получаете 4 или 5 за курс - 100% (при выполнении всех предыдущих работ). Реализация серверной части на django rest. Документирование API.
