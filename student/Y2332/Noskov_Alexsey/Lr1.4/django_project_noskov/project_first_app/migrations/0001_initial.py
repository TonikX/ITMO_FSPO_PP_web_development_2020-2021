    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport_number', models.IntegerField(default='000000', max_length=6)),
                ('home_address', models.CharField(default='Mars', max_length=100, null=True)),
                ('nationality', models.CharField(default='Reptiloed', max_length=30, null=True)),
            ],
            options={
                'verbose_name': 'user',
