...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repair_technique.customer')),
                ('model.md', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repair_technique.modeltechnique')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repair_technique.master')),
                ('price_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repair_technique.pricelist')),
                ('technique', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repair_technique.technique')),
            ],
        ),
        migrations.CreateModel(
            name='Manager',
