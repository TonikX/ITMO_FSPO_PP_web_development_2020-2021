...
class Owner(AbstractUser):
    ...
    def __str__(self):
        return f'{self.pk}, {self.last_name}, {self.first_name}, {self.birth_date}, {self.nationality}, {self.passport_number}, {self.address}'
...
class Auto(models.Model):
    ...
    auto_owner = models.ManyToManyField(settings.AUTH_USER_MODEL, through='AutoOwner')
